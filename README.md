...
The docs_phase3 directory have two files , one which is the video of the website in work , and the other one is a .txt file that contains a google drive link in case  you were unable to download/play the video  
